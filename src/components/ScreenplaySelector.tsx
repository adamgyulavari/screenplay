...
export const ScreenplaySelector = () => {
  ...
  if (availableScreenplays.length === 0) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex items-center justify-center p-6">
        <div className="text-center max-w-md">
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 mx-auto bg-red-600/50 hover:bg-red-500/50 text-white rounded-lg transition-colors duration-200"
          >
      ...
      <div className="max-w-4xl w-full">
        <div className="mb-4 flex justify-center items-center gap-4">
          <h1 className="text-5xl font-bold text-white tracking-tight flex-1">
            {translations.screenplaySelector}
          </h1>
          <button
            onClick={handleLogout}
